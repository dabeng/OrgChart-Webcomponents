...
/***/ function(module, exports, __webpack_require__) {
	...
	Mock.mock('/orgchart/root-node', {
	  ...
	  'children': [{ 'name': 'Bo Miao', 'dept': 'product dept' }, { 'className': 'drill-down asso-rd', 'name': 'Su Miao', 'dept': 'R&D dept' }, { 'name': 'Hong Miao', 'dept': 'finance dept' }, { 'name': 'Chun Miao', 'dept': 'HR dept' }]
	});
	...
	Mock.mock('/orgchart/asso-rd', {
	  ...
	  'name': 'Su Miao',
	  'dept': 'R&D dept',
	  'children': [{ 'name': 'Tie Hua', 'dept': 'backend group' }, { 'className': 'drill-down asso-frontend', 'name': 'Hei Hei', 'dept': 'frontend group' }]
	});
	...
	Mock.mock('/orgchart/asso-frontend', {
	  ...
	  'name': 'Hei Hei',
	  'dept': 'frontend group',
	  'children': [{ 'name': 'Pang Pang', 'dept': 'frontend group' }, { 'name': 'Xiang Xiang', 'dept': 'frontend group',
	    'children': [{ 'name': 'Xiao Xiao', 'dept': 'frontend group' }, { 'name': 'Dan Dan', 'dept': 'frontend group' }, { 'name': 'Zai Zai', 'dept': 'frontend group' }]
	  }]
	});
	...
	function initOrgchart(rootClass) {
	  var orgchart = new _orgchartWebcomponentsMin2.default({
	    ...
	    'createNode': function createNode(node, data) {
	      ...
	      if (node.classList.contains('drill-down')) {
	        (function () {
	          var drillDownIcon = document.createElement('i'),
	          ...
	          drillDownIcon.addEventListener('click', function () {
	            ...
	            var assoChart = chartContainer.querySelector('org-chart.' + assoClass);
	        ...
	        (function () {
	          var drillUpIcon = document.createElement('i'),
	              assoClass = data.className.match(/asso-\w+/)[0];
	
	          drillUpIcon.setAttribute('class', 'fa fa-arrow-circle-up drill-icon');
	          drillUpIcon.addEventListener('click', function () {
	            chartContainer.querySelector('org-chart:not(.hidden)').classList.add('hidden');
	            closest(chartContainer.querySelector('.drill-down.' + assoClass), function (el) {
