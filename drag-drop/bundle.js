...
/***/ function(module, exports, __webpack_require__) {
	...
	document.addEventListener('DOMContentLoaded', function () {
	  ...
	  var datascource = {
	    ...
	    'children': [{ 'name': 'Bo Miao', 'title': 'department manager',
	  ...
	  orgchart.addEventListener('nodedropped.orgchart', function (event) {
	    console.log('draggedNode:' + event.detail.draggedNode.querySelector(':scope > .title').textContent + ', dragZone:' + event.detail.dragZone.querySelector(':scope > .title').textContent + ', dropZone:' + event.detail.dropZone.querySelector(':scope > .title').textContent);
	  });
	});
